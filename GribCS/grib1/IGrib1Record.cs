...
{
    [GuidAttribute("09F181CE-CF5A-44c0-94DA-914812E3071D")]
    public interface IGrib1Record
    {
        long DataOffset { get; }
        Seaware.GribCS.Grib1.IGrib1GridDefinitionSection GDS { get; }
        string Header { get; }
        Seaware.GribCS.Grib1.IGrib1IndicatorSection Is { get; }
        Seaware.GribCS.Grib1.IGrib1ProductDefinitionSection PDS { get; }
    }
}
