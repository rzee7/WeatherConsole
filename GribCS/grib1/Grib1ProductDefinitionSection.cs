...
namespace Seaware.GribCS.Grib1
{
	...
	public sealed class Grib1ProductDefinitionSection : Seaware.GribCS.Grib1.IGrib1ProductDefinitionSection
	{
		...
		/// <returns> timeRange
		/// </returns>
		public System.String TimeRangeString
		{
			get
			{
				return timeRange;
		...
		/// </summary>
		private System.String timeRange = null;
		...
		private System.String tUnit = null;
...
//            bms_exists = (exists & 64) == 64;
		...
		private static System.String getCenter_idName(int center)
		{
			switch (center)
			{
		...
		/// <returns> subCenter
		/// </returns>
		public System.String getSubCenter_idName(int center)
		{
			if (center_id == 7)
			{
				//NWS
