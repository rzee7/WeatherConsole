...
{
    [GuidAttribute("34DA7EEF-D052-4b8b-8F00-8D91CE2FD3A1")]
    public interface IGrib1Input
    {
        int Edition { get; }
        int ProductsCount { get; }
        int RecordsCount { get; }
        IGrib1Record GetRecord(int idx);
        IGrib1Product GetProduct(int idx);
        void scan(bool getProducts, bool oneRecord);
