...
namespace Seaware.GribCS.Grib1
{
	...
	public sealed class Grib1BinaryDataSection : Seaware.GribCS.Grib1.IGrib1BinaryDataSection
	{
		...
		public Grib1BinaryDataSection(System.IO.FileStream raf, int decimalscale):this(raf, decimalscale, null)
		{
		}
