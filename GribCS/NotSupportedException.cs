...
/// <summary> NotSupportedException.java  1.0  16 Sep 2002
/// 
/// </summary>
...
namespace Seaware.GribCS
{
	...
	/// <summary> A class that represents an exception thrown when a GRIB feature is not
	/// (yet) supported.
	/// 
	/// </summary>
	/// <author>   Richard D. Gonzalez
	...
	[ComVisible(false)]
	[Serializable]
	public sealed class NotSupportedException:System.Exception
	{
		...
		/// </param>
		public NotSupportedException(System.String msg):base(msg)
		{
		}
	}
}