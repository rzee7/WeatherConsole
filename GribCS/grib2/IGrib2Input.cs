...
{
    [GuidAttribute("E69FD803-325D-4969-B0F1-8C01E0A10E4F")]
    public interface IGrib2Input
    {
        int Edition { get; }
        int ProductsCount { get; }
        int RecordsCount { get; }
        IGrib2Record GetRecord(int idx);
        IGrib2Product GetProduct(int idx);
        bool scan(bool getProductsOnly, bool oneRecord);
